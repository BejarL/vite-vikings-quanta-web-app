...
import { verifyData } from "../Auth/jwt.js"
...
const ConfirmResetPasswordPage = () => {
  ...
  return (
    ...
    <div className="z-[1] h-[100%] flex items-center justify-center md:w-[100%]">
      <div className="relative bg-white p-9 rounded-lg shadow-md w-[400px] min-w-md min-w-[350px] pt-1 h-[100%] md:flex md:flex-col md:items-center h-[90%] md:w-[70%]">
