...
const HomePage = () => {
  ...
  const recentElems = recentProjects.map((project) => {
    return (
      <button
        ...
        className="flex flex-col items-center justify-center m-[10px] max-w-sm min-w-[200px] min-h-[150px] bg-white border border-white-200 rounded-lg shadow hover:bg-white-100 dark:bg-white-800 dark:border-white-700 dark:hover:bg-violet-100"
      >
        <h5 className="mb-2  font-bold text-black-900 dark:text-black"></h5>
        <p className="font-bold text-white-700 dark:text-white-400">
  ...
  return (
    <div>
      <div className=" flex flex-wrap justify-evenly m-[50px] md:justify-start">
        <div className="m-[10px]">
          <button
            ...
            className="flex flex-col items-center font-bold text-white-700 dark:text-white-400 justify-center max-w-sm min-w-[200px] min-h-[150px] bg-white border border-white-200 rounded-lg shadow hover:bg-white-100 dark:bg-white-800 dark:border-white-700 dark:hover:bg-violet-100"
          >
            <h5 className="mb-2  font-bold text-black-900 dark:text-black">
              <svg
                className="svg2"
      ...
      <h1 className="font-bold text-3xl md:text-4xl m-[20px]">
        Recent Projects
      </h1>
